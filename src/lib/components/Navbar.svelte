...
{#if showBanner}
	<div class="bg-primary-50 border-b border-border py-2 px-4 text-xs font-mono flex justify-center items-center relative">
		<div class="flex items-center gap-2">
			<span class="text-muted">Jetzt neu: Mobiler Autoglas-Service in Franken.</span>
			<a href="#" class="underline decoration-muted hover:text-accent transition-colors">Mehr erfahren.</a>
		</div>
		<button 
...
<nav class="border-b border-border bg-background sticky top-0 z-50">
	<div class="container-custom h-16 flex items-center justify-between">
		...
		<a href="/" class="text-xl font-bold tracking-tight flex items-center gap-2">
			...
			<span class="font-sans font-semibold">autoglas stach</span>
		</a>

		<!-- Links -->
		<div class="hidden md:flex items-center gap-8 font-mono text-xs text-muted">
			<a href="#" class="hover:text-foreground transition-colors">Über uns</a>
			<a href="#" class="hover:text-foreground transition-colors">Leistungen</a>
			<a href="#" class="hover:text-foreground transition-colors">Preise</a>
			<a href="#" class="hover:text-foreground transition-colors">News</a>
			<a href="#" class="hover:text-foreground transition-colors">Häufige Fragen</a>
		</div>
